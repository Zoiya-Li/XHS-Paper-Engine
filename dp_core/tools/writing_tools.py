...
- 实验：有什么关键数据？效果如何提升？
- 意义：这个研究有什么价值？
- 结尾：原始英文论文标题（必须一字不差，绝对禁止翻译成中文），然后换行写标签"""
...
{{
    "title": "最多10字的标题",
    "content": "400-550字的正文（硬性限制不超过550字），完整讲述论文内容，结尾写原始英文论文标题（禁止翻译），然后换行写标签",
